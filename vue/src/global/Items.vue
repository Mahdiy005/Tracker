<template>
  <ul class="p-2 list-none pt-6 px-4 flex flex-col gap-y-3">
    <li>
      <router-link to="/" class="flex gap-x-2 py-2 px-3 link">
        ...
        <span class="text-lightgray text-[16px]"> Dashboard </span>
      </router-link>
    </li>

    <li>
      <router-link to="/attendance" class="flex gap-x-2 py-2 px-3">
        <div class="prepend-icon">
          <img
            src="../assets/images/all-users.svg"
            width="25"
            height="25"
            alt="..."
          />
        ...
        <span class="text-lightgray text-[16px]"> Attendance </span>
      </router-link>
    </li>

    <li>
      <router-link to="/camera-video" class="flex gap-x-2 py-2 px-3">
        <div class="prepend-icon">
          <img
            src="../assets/images/cameravideo.svg"
            width="25"
            height="25"
            alt="..."
          />
